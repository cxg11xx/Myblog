...
<body>
	<div id="container">
		...
		<ul id="menu">
            <li>
                <div id="menuleft"></div>
                <a id="menua" href="http://www.iplaysoft.com">
                    iPlaySoft.com
                </a>
		...
		<div id="content">
			...
			<h1><a target="_blank" href="http://www.iplaysoft.com/usbwebserver.html">USBWebserver V8.6</a> [<a target="_blank" href="http://www.iplaysoft.com">more</a>]</h1>
			<p>
				<ul>
			...
			<a href="http://www.iplaysoft.com/usbwebserver.html" id="banner"></a>
			<br style="clear:both">
