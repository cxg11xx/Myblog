...
if($_POST){
    ...
    $result = $db ->where(['id' => $id])-> update('article',$data);
    ...
    <div class="container">
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="text" name="title" class="form-control" id="exampleInputEmail1" value="<?php echo $row['title']; ?>" placeholder="文章标题">
            </div>
            <div class="form-group">
                ...
                <select name="article_category_id" class="form-control" id="">
                    ...
                    <?php foreach($article_categories as $category) {?>  
                        <option value="<?php echo $category['id']; ?>"
                            <?php if($category['id']==$row['article_category_id']){ ?> selected = "" <?php } ?>>
            ...
            <div class="form-group">
                ...
                <input type="text" name="thumb" class="form-control" id="exampleInputEmail1" value="<?php echo $row['thumb']; ?>" placeholder="文章配图">
            </div>
            <div class="form-group">
                <label for="">文章详情</label>
                <textarea name="content" id="" cols="30" rows="10" class="form-control"><?php echo $row['content']; ?></textarea>
            </div>
